// GET  https://<your-vercel-domain>/api/recommend  -> health message
// POST https://<your-vercel-domain>/api/recommend  -> outfit JSON
...
Keys: headwear, top, midlayer, bottoms, footwear, accessories, palette{primary,accent,neutral}, rationale.
Consider age, gender, skin tone bucket (light/medium/deep), undertone (warm/cool/neutral), season. No brands.`;
    ...
    let json;
    try { json = JSON.parse(text); } catch { json = { error: 'LLM returned non-JSON', raw: text }; }
